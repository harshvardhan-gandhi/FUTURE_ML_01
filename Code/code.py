...
plt.plot(prophet_df["ds"], prophet_df["y"], label="Actual", color="#2E8B57", linewidth=2)
plt.plot(forecast["ds"], forecast["yhat"], label="Forecast", color="#FF8C00", linewidth=2)
plt.fill_between(
    forecast["ds"],
    forecast["yhat_lower"],
    forecast["yhat_upper"],
...
plt.title("Monthly Sales Forecast with Prophet", fontsize=16)
